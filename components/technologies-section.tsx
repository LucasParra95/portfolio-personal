  ...
  return (
    <section id="technologies" className="py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-16">Tecnologías</h2>
            ...
            return (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-center">{technology.name}</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed text-center">{technology.description}</p>
                </CardContent>
              </Card>
            )
          })}
